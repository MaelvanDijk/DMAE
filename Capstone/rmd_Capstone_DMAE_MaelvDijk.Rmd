...
1.   Er is een klein positief lineair verband tussen het aantal skills
    en het mediaan gebode salaris
2.  Het referentie salaris van HoB is pas vanaf het 3e jaar
    'competitief' te noemen

*De drie grafieken in ogenschouw genomen is er niet direct een verband
aan te wijzen tussen het aantal skills. Een eerste hypothese zou zijn om
te stellen dat de toename van skills iemand waardevoller maakt (een
vershuiving van de curve naar rechts) dit gebeurt echter niet. een
andere aannamen kan zijn dat generalisten specialisten meer waard zijn
of dat hoger betaalde functies (zoals manager en c-niveau) minder
hard-skills nodig hebben. Beide ontwikkelingen komen niet (sterk) terug
in onderstaande grafiek. Wel is op te maken 3e jaars HoB personeel (er
vanuitgaande dat op dit moment 5 skills beheerst worden) minder loon
ontvangen dan wat er op de Nederlandse markt geboden wordt. In een
volgende analyse zou wenselijk zijn om de loon verdeling per aantal
skills en het aantal jaren werkervaring te plotten dit is echter niet
mogelijk door het te lage aantal observaties per mogelijke subset van de
data.*
