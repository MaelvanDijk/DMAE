...
kunnen worden en welke artifacten opgeleverd worden
...
### Hoe verhoudt het loon van HoB zich tot de Nederlandse banenmarkt op het gebied van data specialisten?
...
het modale salaris dat op indeed geboden wordt tot en met jaar 5.
...
voor 3, 4, en 5 skills te zien. De drie grafieken in ogenschouw genomen
is er niet direct een verband aan te wijzen tussen het aantal skills.
Een eerste hypothese zou zijn om te stellen dat de toename van skills
iemand waardevoller maakt (een vershuiving van de curve naar rechts) dit
gebeurt echter niet. een andere aannamen kan zijn dat generalisten
specialisten meer waard zijn of dat hoger betaalde functies (zoals
manager en c-niveau) minder hard-skills nodig hebben. Beide
ontwikkelingen komen niet (sterk) terug in onderstaande grafiek. Wel is
op te maken 3e jaars HoB personeel (er vanuitgaande dat op dit moment 5
skills beheerst worden) minder loon ontvangen dan wat er op de
Nederlandse markt geboden wordt. In een volgende analyse zou wenselijk
zijn om de loon verdeling per aantal skills en het aantal jaren
werkervaring te plotten dit is echter niet mogelijk door het te lage
aantal observaties per mogelijke subset van de data.
.....................
