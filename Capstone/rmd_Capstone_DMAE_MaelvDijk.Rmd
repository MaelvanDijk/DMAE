...
*".\\Data_raw\\D002\\2022-03-08 scraped indeed data.csv"*. Dit voorbeeld
bestand bestaat uit:
...
terug te gaan dan februari 2022.
...
dateframe. D002 bevat salarissen op zowel maand als jaar basis. Dit is
de tweede transformatie, alle waarden boven 10.000 delen door 12
maanden. 10.000 is gekozen omdat dit een niet waarschijnlijk salaris is
voor zowel jaar-, en maandsalaris.
...
grafiek. Hier uit valt op te maken dat na de bij de tweede
loonsverhoging (jaar 3) het salaris van een HoB data consultant hoger
ligt dan het geboden salaris in \> 50% van de vacatures.
